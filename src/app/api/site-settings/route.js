...
/**
 * GET handler to retrieve global site settings and live application statistics.
 * Aggregates real-time counts for jobs, companies, and candidates if configured.
 */
